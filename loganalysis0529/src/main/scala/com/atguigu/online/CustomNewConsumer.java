...
// value的序列化类
        ...
        props.put("zookeeper.connect","hadoop102:9092,hadoop103:9092,hadoop101:9092");
...
// 消费者订阅的topic, 可同时订阅多个
        consumer.subscribe("tc");

        while (true) {
// 读取数据，读取超时时间为100ms
            Map<String, ConsumerRecords<String, String>> poll = consumer.poll(100);
